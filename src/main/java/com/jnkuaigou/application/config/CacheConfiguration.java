...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jinNiuKuaiGouApplicationVue");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jinNiuKuaiGouApplicationVue");
        ...
        config.getMapConfigs().put("com.jnkuaigou.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
